...
class CollectionStore:
    def __init__(self):
        self._collections:dict[tuple[str, Session], tuple[UUID, Filters]] = {}

    def exists(self, collection_name:str, session:Session)-> bool:
        return (collection_name, session) in self._collections

    def get_schema_id(self, collection_name:str, session:Session) -> UUID:
    ...
    def save_collection(self, session:Session, collection_name:str, schema_id:UUID, filters:Filters):
